...
work_path=/home/rotem.kendel/projecctA/Hadoop/complex_terms
cd "$work_path"
...
hadoop jar "$work_path"/complexTerm.jar ComplexTermDriver $INPUT_DIR $OUTPUT_DIR
