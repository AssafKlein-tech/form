...
# Example usage
file_paths = ["/home/assaf/Repos/form/iostat_output_mpi2.txt", "/home/assaf/Repos/form/iostat_output_reg2.txt"]  # Replace with your actual paths
device_name = "sdd"  # Or "sda", etc.
